...
**
** Note that the "compressed image" has the entire JFIF formatted
** file structure, including header info.
**
** img_buf: (in) pointer to uncompressed source image data in RGB format
** buffer_size: (in) size of the source image buffer, in bytes
** width: (in) width of source image in pixels
** height: (in) height of source image in pixels
** jpeg_buffer: (in/out) pointer to compressed image data buffer
** jpeg_buffer_size: (in) maximum size of the compressed image data buffer
** quality: (in) a compression quality factor
** jpeg_comp_size: (out) size of the destination compressed image, in bytes
*/
                   ...
                   int quality, unsigned long *jpeg_comp_size, int input_components)
{
  ...
  */
  ...
  cinfo.in_color_space = input_components == 1 ? JCS_GRAYSCALE : JCS_RGB; /* colorspace of input image */
   ...
   */
  row_stride = width * input_components; /* JSAMPLEs per row in image_buffer */
